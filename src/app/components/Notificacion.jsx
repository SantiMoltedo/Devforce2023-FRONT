        ...
        <>
            <div class={`toastNuevo toast-header-${accion}`} id="noti">
                <div className="toast-content">
                    <span><i className={`fa-solid ${accion == 'aprobada' && 'fa-check'} ${accion == 'modificado' && 'fa-check'} ${accion == 'creada' && 'fa-check'} ${accion == 'creado' && 'fa-check'} ${accion == 'rechazada' && 'fa-xmark'} ${accion == 'campos' && 'fa-xmark'} ${accion == 'devuelta' && 'fa-clock'}`}></i></span>
